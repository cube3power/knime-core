...
final class CrossJoinerNodeModel extends NodeModel {
    ...
    private void crossJoin(final RowInput lData, final BufferedDataTable rData, final RowOutput output,
        ...
        double rowCounter = 0;
        final ArrayList<DataRow> lDataChunk = new ArrayList<DataRow>(chunksize);
        final ArrayList<DataRow> rDataChunk = new ArrayList<DataRow>(chunksize);
        ...
        while (!finished) {
            ...
            finished = rDataChunk.size() < chunksize;
     ...
     */
    private static void fillRightDataChunk(final ArrayList<DataRow> list, final CloseableRowIterator rowIt,
     ...
     * @throws CanceledExecutionException - If the execution was canceled
     */
    private static void fillLeftDataChunk(final ArrayList<DataRow> list, final RowInput data, final int chunkSize,
